...
import AnalyticalModelModule from '../components/analysis/AnalyticalModelModule'

const MODULE_MAP: Record<ActiveModule, React.FC> = {
  dashboard:     DashboardModule,
  project_setup: ProjectSetupModule,
  modeling:      ModelingModule,
  analysis:      AnalyticalModelModule,
  // Placeholders for future phases
  loads:      () => <PlaceholderModule title="লোড ডেফিনিশন"          phase={2} />,
  design:     () => <PlaceholderModule title="মেম্বার ডিজাইন"         phase={6} />,
  detailing:  () => <PlaceholderModule title="ডিটেইলিং"              phase={8} />,
  drawing:    () => <PlaceholderModule title="ড্রয়িং জেনারেশন"       phase={9} />,
  bbs:        () => <PlaceholderModule title="বার বেন্ডিং শিডিউল"    phase={10} />,
  compliance: () => <PlaceholderModule title="BNBC কমপ্লায়েন্স"      phase={11} />,
  report:     () => <PlaceholderModule title="রিপোর্ট এক্সপোর্ট"     phase={12} />,
}
